...
//This is intermediary Node Code
//By Jeffrey Wu
//This one is not frozen
...
#define WIZFI220
//#define WIZFI210
#define LED_ON_POWER 80

//output debug digests on Serial.
//comment this line for full WizFi operation
#define TESTING
//allows free commands to WizFi
//s#define TESTING_COMMAND_MODE
//verbose packet output
//#define DIGEST

//=====LEGACY TRANSMIT SETTINGS=====
//transmit to HADES
#define TEST_UP1
...
//=====END WIZFI PIN LAYOUTS

//=====DEFINE PCB BOARD PARAMS=====
//LED ILLUMINATION
...
void WizFiSetup(){
  ...
  analogWrite(LED_POWER,LED_ON_POWER); //set Green LED ON
  ...
  analogWrite(LED_CONNECTED,LED_ON_POWER); //set Orange LED ON
...
unsigned int readBatt(){
  ...
  result = result*volt_multiplier; //map to 10*voltage.
...
//TODO: READ THE NODE DIAGNOSTICS
void readNodeDiagnostic(){
